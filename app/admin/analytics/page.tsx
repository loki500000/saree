...
export default function SuperAdminAnalyticsPage() {
  ...
  const fetchAnalytics = async () => {
    try {
      const res = await fetch(`/api/admin/analytics/advanced?period=${period}&groupBy=day`, {
        credentials: 'include'
      });
      const data = await res.json();
      console.log('Super Admin Analytics response:', data); // Debug log
      if (data.error) {
        console.error('Super Admin Analytics API error:', data.error);
        return;
      }
      setAnalytics(data);
    } catch (error) {
  ...
  const exportToCSV = () => {
    ...
    a.href = url;
    a.download = `super-admin-analytics-${period}-${new Date().toISOString().split('T')[0]}.csv`;
    a.click();
  };
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1 text-sm">Global platform performance and insights</p>
              </div>
            </div>
        ...
        {!hasData ? (
          ...
          <div className="bg-white rounded-3xl shadow-xl p-16 text-center border border-gray-100">
            ...
            <p className="text-gray-600 mb-8 max-w-md mx-auto text-lg">
              No global analytics data available yet.
            </p>
          </div>
        ) : (
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-100">
                    <div className="mb-6">
                      <h2 className="text-xl font-bold text-gray-900">Top Clothing Items (Platform)</h2>
                      <p className="text-sm text-gray-500 mt-1">Most popular items across all stores</p>
                    </div>
            ...
            {activeTab === 'insights' && (
              <div className="space-y-6">
                ...
                {analytics?.creditBreakdown && analytics.creditBreakdown.length > 0 && (
                  <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-100">
                    <div className="mb-6">
                      <h2 className="text-xl font-bold text-gray-900">Credit Flow (Platform)</h2>
                      <p className="text-sm text-gray-500 mt-1">Transaction breakdown across all stores</p>
                    </div>
            ...
            {activeTab === 'users' && (
              <div className="space-y-6">
                ...
                {analytics?.topUsers && analytics.topUsers.length > 0 && (
                  <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-100">
                    <div className="mb-6">
                      <h2 className="text-xl font-bold text-gray-900">Top Users (Platform)</h2>
                      <p className="text-sm text-gray-500 mt-1">Most active users across all stores this period</p>
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-100">
                  <div className="mb-6">
                    <h2 className="text-xl font-bold text-gray-900">Latest Activity (Platform)</h2>
                    <p className="text-sm text-gray-500 mt-1">Recent try-on sessions across all stores</p>
                  </div>
