-- ============================================
-- STORE COMPARISON ANALYTICS MIGRATION
-- Version: 1.0.0
-- Description: Add SQL functions for store comparison analytics
-- ============================================
...
BEGIN
    ...
    store_popular_items AS (
        SELECT DISTINCT ON (th.store_id)
            th.store_id,
            th.clothing_image_url AS popular_item_url,
...
SELECT COUNT(*) AS functions_created FROM information_schema.routines WHERE routine_name LIKE 'get_store%';
